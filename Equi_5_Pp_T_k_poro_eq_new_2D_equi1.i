...
[Mesh]
  [file] # Input File in order to reach pressure equilibrium after hundreds of years
    ...
    file = '2D_15km_centrado_equi1.msh'
  []
[]
...
[Functions]
  ...
  #   expression = if(t<start_time,Tini+(t/start_time)*Tvolcan,Tvolcan)
  # []
[]
...
[AuxKernels]
  ...
  [permeability]
    ...
    # expression = 'pow(10,((22-13.5)/(1+exp(0.05*(temp-720.15)))-22))' #SOFT
    expression = 'pow(10,((22-13.5)/(1+exp(0.28*(temp-652.23)))-22))' #MORE SHARP   
    # expression = perm_func
    execute_on = 'INITIAL' #TIMESTEP_END'
  []
  [effective_fluid_pressure] #fully saturated equal to pwater
    type = ParsedAux
    coupled_variables = 'pres_water pgas swater sgas'
    expression = 'pres_water * swater + pgas * sgas'
...
[VectorPostprocessors]
  [parameters]
    ...
    num_points = 700
    sort_by = z
    variable = 'pres_water temp permeability porosity effective_fluid_pressure poro_x poro_y'
  []
[]
